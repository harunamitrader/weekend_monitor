...
IG 証券の weekend 14 銘柄を監視し、以下を表示するシンプルな公開 Web ページを構築する。
...
監視対象は、IG の `weekend` ページにある以下の 14 銘柄。
...
- `data/markets.json`: 14 銘柄の定義と IG URL を持つ管理ファイル
...
2. 14 銘柄の定義を持つ `markets.json` を作る
